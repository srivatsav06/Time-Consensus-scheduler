...
INSERT INTO requests (reqid, dateandtime, status, title, description) VALUES (nextval('requests_seq'), '2023-09-17 10:00:00', 'PENDING', 'Title 1', 'Description 1');

INSERT INTO participantrequests (reqid, userid) VALUES (1, 1),(1, 51);

--Insert a new event
INSERT INTO events (eventid, title, description, dateandtime) VALUES (nextval('events_seq'), 'Sample Event', 'This is a sample event description', '2023-09-16 15:30:00');
